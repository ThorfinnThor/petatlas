...
**M00 bis M07 vollständig, M08 bei 4/6 (52 von 121 Aufgaben).** Der genaue Stand steht in `project/tasks.json`; `npm run status` gibt ihn aus.
...
**M08-05 — Druck- und Informationsseiten erstellen.** Druckansicht mit Quellen und Fassung; wenige freigegebene Leistungsseiten mit Rechner-Einstieg. Keine automatische Massenerzeugung.
