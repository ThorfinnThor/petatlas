...
**M20-03 — Weitere kommunale Quellen aufnehmen.** Offene Datensätze weiterer Städte prüfen: Rechte zuerst, dann Adapter, dann Snapshot und Konfliktprüfung.

Danach (weitere kommunale Quellen), M21-01 bis M21-06 (Designvertrag zu Ende), M22-01 bis M22-04 (Datenqualität). Der Block ist in `docs/MILESTONES.md` und im Manifest beschrieben.

Bereits fertig: 1006 Gebührenpositionen mit eigener Seite, 150 Gruppenseiten, ein Katalogeinstieg und 42 statt 25 Stadtseiten. Der Build erzeugt jetzt 1233 Seiten statt 60.
