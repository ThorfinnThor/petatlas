...
Fertig aus dem Block M20 bis M22: 1006 Gebührenpositionen mit eigener Seite, 150 Gruppenseiten und ein Katalogeinstieg (M20-01); 42 statt 25 Stadtseiten (M20-02); die zweite kommunale Quelle — Hamburg, 140 Auslaufzonen nach § 8 HundeG unter `dl-de/by-2-0` — samt verallgemeinertem Snapshot- und Abgleichlauf über ein Quellenverzeichnis, und beide kommunalen Quellen sind jetzt auf den Stadtseiten sichtbar statt nur im Repository (M20-03); der bundesweite OSM-Import mit Standdatum im Snapshot (M22-01). Der Build erzeugt 1232 Seiten mit freigeschalteten Funktionen, 12 ohne.
...
**M21-01 — Komponentenbibliothek anlegen.** Die im Designvertrag beschriebenen Bausteine als eigene Komponenten, damit sie nicht je Seite neu entstehen.

Danach M21-02 bis M21-06 (Designvertrag zu Ende), M22-02 bis M22-04 (Datenqualität). Der Block ist in `docs/MILESTONES.md` und im Manifest beschrieben.
