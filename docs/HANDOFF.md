...
**M00 bis M07 vollständig, M08 bei 5/6 (M08-06 blockiert), M10 bei 1/6 (54 von 121 Aufgaben).** Der genaue Stand steht in `project/tasks.json`; `npm run status` gibt ihn aus.
...
**M10-02 — Geometrie und Kontakte normalisieren.** Ways und Relations brauchen einen berechneten repräsentativen Punkt; im Bremen-Pilot betrifft das 19 von 74 Treffern, vor allem Hundewiesen. Alternativ M09-01 oder M12-01.
