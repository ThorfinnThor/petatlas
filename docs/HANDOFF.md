...
**M21-03 — Zweispaltige Tool-Ansicht für den Rechner.** Eingaben und Ergebnis nebeneinander ab Tablet, einspaltig darunter; mobil bleibt die Reihenfolge Eingabe, Aktion, Ergebnis.

Danach M21-04 bis M21-06 (Designvertrag zu Ende), M22-02 bis M22-04 (Datenqualität). Der Block ist in `docs/MILESTONES.md` und im Manifest beschrieben.
