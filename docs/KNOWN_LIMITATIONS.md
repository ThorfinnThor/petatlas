...
Was diese Plattform **nicht** kann, nicht weiß und nicht verspricht. Stand 2026-09-08.
...
- **Der Ortsdatensatz kennt seinen eigenen Stand nicht.** Der bundesweite Import schrieb bis M17-04 kein Abrufdatum mit. Der Datenstand weist ihn deshalb als „unbekannt“ aus; der nächste Import trägt es ein.
...
- **Für Österreich und die Niederlande wird nichts beobachtet.** Im Repository ist keine belegte Adresse festgehalten, und eine geratene wäre schlimmer als keine.
...
- **Der Provider-Rollback ist nicht erprobt.** Es gibt kein Deployment. Was im Runbook stünde, wäre abgeschrieben statt gemessen.
...
- **85 KiB Schemabibliothek in jeder datenladenden Seite** (23 KiB komprimiert). Der Preis dafür, dass der Browser prüft, was er lädt, statt es zu glauben.
- **Keine Suche über Fachdaten.** Die Volltextsuche findet Seiteninhalte, nicht einzelne Gebührenpositionen oder Orte.
